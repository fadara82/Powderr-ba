...
function editProduct(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // Inicijalizacija validacije i submit handlera
      $("#exampleModale").validate({
        rules: {
          ...
          // možeš dodati ostale validacije ako želiš
        },
        submitHandler: function (form, event) {
          event.preventDefault();
...
// Funkcija koja provjerava je li proizvod na stanju u bazi
...
// Funkcija za dodavanje proizvoda u košaricu nakon provjere
function addToCart(id) {
  checkProductAvailability(id, function (product) {
    if (!product) return; // nema proizvoda ili nije na stanju
...
// Funkcija za mijenjanje količine proizvoda u košarici
  ...
  $("#loginform").validate({
    ...
    submitHandler: function (form, event) {
      ...
      $.ajax({
        ...
        complete: function () {
          // Nakon ajax poziva obavezno ukloni blokadu
          $.unblockUI();
        },
      });
    },
